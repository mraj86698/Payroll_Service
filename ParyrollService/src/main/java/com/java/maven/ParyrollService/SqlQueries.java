...
public class SqlQueries {
	...
	public final String sum="SELECT SUM(basic_pay) FROM payroll_tbl ";
	public final String avg="select avg(basic_pay) from payroll_tbl ";
	public final String min="select min(basic_pay) from payroll_tbl ";
	public final String max="select max(basic_pay) from payroll_tbl ";
	...
	public final String INSERT_EMP_PAYROLL_DATA = "insert into payroll_tbl "
			...
			+ "values (?, ?, ?, ?, ?, ?)";
	public final String Delete="delete from employee WHERE EmployeeName = ?";
